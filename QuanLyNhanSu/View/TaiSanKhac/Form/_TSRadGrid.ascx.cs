...
{
    public partial class _TSRadGrid : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (this.Page.IsPostBack)
                _tsEntity.Load_AllTaiSanKhacOfKeKhai_ToRadGrid(rgTaiSan, _kekhaiID);
        }
        ...
        protected void rgTaiSan_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
        {
            if(e.Item is GridFilteringItem)
            {
                ...
                TextBox taisan = item["TSKTen"].Controls[0] as TextBox;
