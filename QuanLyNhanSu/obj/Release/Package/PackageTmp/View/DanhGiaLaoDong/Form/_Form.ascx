<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="_Form.ascx.cs" Inherits="QuanLyNhanSu.View.DanhGiaLaoDong.Form._Form" %>
...
<asp:Table runat="server" CssClass="rbTable">
    ...
    <asp:TableRow>
        <asp:TableCell CssClass="rbTableCellLabel">
            Đánh giá và phân loại lao động năm:
        </asp:TableCell>
        <asp:TableCell>
            ...
            <asp:RequiredFieldValidator ID="rfvNam" runat="server" ControlToValidate="txtNam" Display="Dynamic"
                ErrorMessage="Nhập năm đánh giá và phân loại lao động" ForeColor="Red" Font-Italic="true"></asp:RequiredFieldValidator>
    ...
    <asp:TableRow>
        <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
            <b>I. TỰ ĐÁNH GIÁ KẾT QUẢ CÔNG TÁC, TU DƯỠNG, RÈN LUYỆN CỦA LAO ĐÔNG:</b>
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow>
        <asp:TableCell CssClass="rbTableCellLabel">
    ...
    <asp:TableRow>
        ...
        <asp:TableCell>
            ...
            <asp:RequiredFieldValidator ID="rfvTrachNhiem" runat="server" ControlToValidate="txtTrachNhiem" Display="Dynamic"
                ErrorMessage="Nhập trách nhiệm, thái độ phục vụ nhân dân, tinh thần hợp tác với đồng nghiệp và việc thực hiện quy tắc ứng xử của người lao động"
                ForeColor="Red" Font-Italic="true"></asp:RequiredFieldValidator>
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow>
        ...
        <asp:TableCell>
            ...
            <asp:RequiredFieldValidator ID="rfvNghiaVu" runat="server" ControlToValidate="txtNghiaVu" Display="Dynamic"
                ErrorMessage="Nhập việc thực hiện các nghĩa vụ khác của người lao động" ForeColor="Red" Font-Italic="true"></asp:RequiredFieldValidator>
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow>
        <asp:TableCell><br /></asp:TableCell>
    ...
    <asp:TableRow>
        <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
            <b>
                II. TỰ ĐÁNH GIÁ, PHÂN LOẠI CỦA LAO ĐỘNG:
            </b>
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow>
