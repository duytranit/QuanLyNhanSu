<%@ Page Title="NhanSu" Language="C#" MasterPageFile="~/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="CUD.aspx.cs" Inherits="QuanLyNhanSu.View.NhanVien.Admin.CUD" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row rb-row">
        <div class="col-md-4 col-md-4-full-width">
            ...
            <asp:Panel ID="pnlExtraInforamtion" runat="server" Visible="false">
