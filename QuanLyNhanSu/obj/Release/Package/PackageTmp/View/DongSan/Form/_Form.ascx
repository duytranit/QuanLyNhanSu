<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="_Form.ascx.cs" Inherits="QuanLyNhanSu.View.DongSan.Form._Form" %>
    ...
    <asp:TableRow>
        ...
        <asp:TableCell>
            <telerik:RadTextBox ID="txtTen" runat="server" WrapperCssClass="rbRadTextBox"
                EmptyMessage="Tên tài sản" EmptyMessageStyle-BorderColor="Red" EmptyMessageStyle-Font-Italic="true"></telerik:RadTextBox>
            <asp:RequiredFieldValidator ID="rfvTen" runat="server" ControlToValidate="txtTen" Display="Dynamic"
                ErrorMessage="Nhập tên tài sản" ForeColor="Red" Font-Italic="true"></asp:RequiredFieldValidator>
        </asp:TableCell>
    </asp:TableRow>
    <asp:TableRow>
        <asp:TableCell CssClass="rbTableCellLabel">
    ...
    <asp:TableRow>
        ...
        <asp:TableCell>
            ...
            <asp:RequiredFieldValidator ID="rfvGiaTri" runat="server" ControlToValidate="txtGiaTri" Display="Dynamic"
                ErrorMessage="Nhập giá tị của tài sản" ForeColor="Red" Font-Italic="true"></asp:RequiredFieldValidator>
